...
clean:
	...
	rm -f ComputeAverage
	rm -f DistanceMatrix
	rm -f HistogramsOfBarcodesLength
	rm -f minMaxBarcodes
	...
	rm -f Anova.exe
	rm -f BinningOnDiagram.exe
	rm -f ClassifierBasedOnAllDimensions.exe
	rm -f ClassifierBasedOnSingleDimension.exe
	rm -f ComputeAverage.exe
	rm -f DistanceMatrix.exe
	rm -f HistogramsOfBarcodesLength.exe
	rm -f minMaxBarcodes.exe
	rm -f NormalizeBarcodes.exe
	rm -f NthMoment.exe
	rm -f PermutationTest.exe
	rm -f PlotOfLandscape.exe
	rm -f PlotsOfDiagram.exe
	rm -f PlotsOfDiagrams.exe
	rm -f PlotsOfLandscapesViaScripts.exe
	rm -f PlotsOfLandscapeViaScripts.exe
	rm -f ScalarProducts.exe
	rm -f StandardDeviation.exe
	rm -f T-StudentTest.exe
	rm -f VerifyAverageOfPopulationWithT-Test.exe
